...
\addcss+.eqnnumber {float: right;}+
\addcss+.eqnnumber:before {content: "(";}+
\addcss+.eqnnumber:after {content: ")";}+
\addcss+.alignnumber:before {content: "(";}+
\addcss+.alignnumber:after {content: ")";}+
\addcss+.alignnumber_row {vertical-align: middle;}+
\addcss+table.align {width: 100%;}+
\addcss+table.align > tr {vertical-align: top;}+
\addcss+table.align td.label {width: 2em;}+
